...
<html lang="en">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat" >
		...
		<!--begin::Root-->
		<div class="d-flex flex-column flex-root" id="kt_app_root" style="background-image: url('<?php echo e(asset('assets/media/auth/bg.png')); ?>'); background-size: cover; background-repeat: no-repeat;">
			<!--begin::Page bg image-->
			<!--end::Page bg image-->
			<div class="d-flex justify-content-center p-12">
				<img src="<?php echo e(asset('assets/media/logos/logo.png')); ?>" width="240px">
			</div>
	...
	<!--end::Body-->
</html><?php /**PATH C:\xampp\htdocs\pipcollective\resources\views/auth/auth-layout.blade.php ENDPATH**/ ?>