        ...
        <div class="card-header border-0 pt-6 mb-2 mb-sm-0">
            ...
            <div class="card-title flex-stack flex-row-fluid">
                <div class="d-flex flex-column">
                    <span class="fw-bolder fs-1x text-gray-900">Courses</span>
...
<?php echo $__env->make('componants.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pipcollective\resources\views/admin/courses.blade.php ENDPATH**/ ?>