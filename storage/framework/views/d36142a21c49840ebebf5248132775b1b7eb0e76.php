...
<?php $component = $__env->getContainer()->make(App\View\Components\CustomerTable::class, ['titleColumnName' => 'Course Title','data' => $Courses,'editModalId' => 'edit-course','deleteModalId' => 'delete-course','editFunction' => 'editcourse','deleteFunction' => 'deletecourse']); ?>
...
<!--end::Pages-->
<div class="fs-6 fw-semibold text-gray-700">Showing <?php echo e($Courses->count()); ?> of <?php echo e($Courses->total()); ?> of <?php echo e($Courses->total()); ?> entries</div>
...
<?php echo $__env->make('componant.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pipcollective\resources\views/admin/courses.blade.php ENDPATH**/ ?>