...
<div style="background-image: url('<?php echo e(asset('assets/media/auth/bg.png')); ?>'); background-size:cover" id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: false, lg: '300px'}" >
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                ...
                <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div class="menu-item me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <a href="<?php echo e(url('user/my-accounts')); ?>">
    ...
    <!--end::Header container-->
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					<!--begin::Toolbar-->
					<div id="kt_app_toolbar" class="app-toolbar py-6" style="background-image: url('<?php echo e(asset('assets/media/auth/bg.png')); ?>'); background-size: cover;">
	...
	<!--end::Body-->
</html><?php /**PATH C:\xampp\htdocs\pipcollective\resources\views/users/dashboard.blade.php ENDPATH**/ ?>