	...
	<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				<!--begin::Header-->
				<?php echo $__env->make('componant.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<!--end::Header-->
				<!--begin::Wrapper-->
								...
								<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-lg-10 pt-sm-6 pb-7">
									...
									<div class="page-title me-5">
										...
										<div class="d-flex align-items-center pt-1">
											<?php echo $__env->make('componant.breadcrumb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
										</div>
										<!--end::Title-->
									</div>
									<!--end::Page title-->
							...
							<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_content" class="app-content flex-column-fluid">
									...
									<div class="row g-5 g-xl-8">
										...
										<div class="col-xl-3">
											<!--begin::Misc Widget 1-->
											<?php echo $__env->make('componant.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
											<!--end::Misc Widget 1-->
										</div>
										<!--end::Col-->
										<!--begin::Col-->
		...
		<?php echo $__env->make('componant.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
